...
public class EFTP107 {
	  private String reportDirectory = "reports";
	  private String reportFormat = "xml";
	  private String testName = "EFTP107 Séléctionner une thématique";
      ...
      driver.findElement(By.xpath("//*[@id='parking_spinner1']")).click();
      new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@text='Horodateur']")));  
      driver.findElement(By.xpath("//*[@text='Horodateur']")).click();
