...
public class EFTP124 {
	  private String reportDirectory = "reports";
	  private String reportFormat = "xml";
	  private String testName = "EFTP124 Cliquer sur Quitter";
      ...
      driver.findElement(By.xpath("//*[@text='Validation']")).click();
      new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@text='Imprimante non configurée, continuer sans imprimer ?']"))); 
      
      driver.findElement(By.xpath("//*[@text='Oui']")).click();
      new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@text='Imprimer']"))); 
      new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@text='Suivant']"))); 
      
      driver.findElement(By.xpath("//*[@text='Suivant']")).click();

      new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@text=concat('Reconnaitre la plaque. L', \"'\", 'opération peut prendre quelques secondes')]"))); 
