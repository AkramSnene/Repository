...
public class EFTP119 {
	  private String reportDirectory = "reports";
	  private String reportFormat = "xml";
	  private String testName = "EFTP119 Séléctionner une catégorie";
      ...
      driver.findElement(By.xpath("//*[@id='category_spinner']")).click();
      driver.findElement(By.xpath("//*[@text='VOITURE PERSONELLE']")).click();
